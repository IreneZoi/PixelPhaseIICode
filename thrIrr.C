...
void SCurve(string fileIn, string fileOut, string quadrant)
{
  ...
  TH1D* hPar0_25x600 = new TH1D("hPar0_25x600","hPar0",100,1200,7000);
  TH1D* hPar0_50x300 = new TH1D("hPar0_50x300","hPar0",100,1200,7000);
  TH1D* hPar0_100x150 = new TH1D("hPar0_100x150","hPar0",100,1200,7000);
  ...
  */
  ...
  tPrel->DrawLatex(0.09821429,0.9194523,"Test Beam FNAL, May 2016, Dut2=RSPA");
  ...
  c0->Print("../Tesi/calibrations_images/May2016Threshold3conf.eps");
  ...
  */ //c0_100x150->Modified();
  ...
  tPrel2->DrawLatex(0.09821429,0.9194523,"Test Beam FNAL, May 2016, Dut2=RSPA");
...
//  leg2->AddEntry(  hPar1_100x150,"100x150","lpf");
  ...
  c2->Print("../Tesi/calibrations_images/May2016Noise3conf.eps");
